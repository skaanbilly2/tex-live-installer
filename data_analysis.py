...
size_keys = [key for key in ["containersize", "doccontainersize", "srccontainersize"] if key.endswith("containersize")]
pd.DataFrame()
...
df = pd.DataFrame({"containersize": contsize, "doccontainersize": doccontsize, "srccontainersize":srccontsize, "tot_size": tot_size})
print(df.describe())
df.boxplot()
plt.show()
